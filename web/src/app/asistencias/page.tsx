    ...
    <Protected>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Asistencias registradas</h1>
            <p className="text-gray-600">Últimos registros, del más reciente al más antiguo</p>
          </div>
        </div>
        ...
        {loading ? (
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Proyecto</th>
                  ...
                  {filtered.map((x) => {
                    ...
                    return (
                      <tr key={x.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-900"><BenefName b={x.beneficiario} /></td>
                        <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-900">{proyecto}</td>
                        <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-900">
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">Comienza registrando asistencia en una actividad</p>
          </div>
        )}
      </div>
    </Protected>
